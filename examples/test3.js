var sftp = require('../index.js').sftp;
var client = new sftp();
...
client.init(options, function(err){
  ...
  client.connect(function(err){
    ...
    //client.exec("cd cloud9", function(err, data) {
      //console.log("cd: ", err, data);
      //client.exec("cd async.js; git log", function(err, data) {
      //  console.log("log: ", err, data);  
      //});  
    //});

    //var blah = client.spawn("cd async.js; git log");
    var blah = client.spawn("node ./blah.js");
